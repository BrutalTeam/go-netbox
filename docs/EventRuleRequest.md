...
`func NewEventRuleRequest(objectTypes []string, actionType EventRuleActionTypeValue, actionObjectType string, ) *EventRuleRequest`
...
`func (o *EventRuleRequest) HasName() bool`
