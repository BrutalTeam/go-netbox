...
`func NewWritableDeviceTypeRequest(manufacturer BriefManufacturerRequest, model string, ) *WritableDeviceTypeRequest`
...
`func (o *WritableDeviceTypeRequest) HasSlug() bool`
